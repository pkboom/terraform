...
echo >&2 "[$INFRA_ENV:$INFRA_ROLE] Setting up cloudcasts.io application"
...
echo >&2 "[$INFRA_ENV:$INFRA_ROLE] Installing application dependencies"
...
if [[ "$INFRA_ROLE" == "http" ]]; then
    echo >&2 "[$INFRA_ENV:$INFRA_ROLE] Reloading PHP-FPM"
...
if [[ "$INFRA_ROLE" == "queue" ]]; then
    echo >&2 "[$INFRA_ENV:$INFRA_ROLE] Preparing queue workers"
